...
The shared Axum framework layer. Provides middleware, extractors, and response types that every app service uses. Depends on `Nun`, `Heka`, `Lethe`.
...
│   │   ├── rate_limit.rs  # Token bucket rate limiter (uses Lethe/DragonflyDB)
